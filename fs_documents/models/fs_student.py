...
"""Flight School Documents fs student module.

Purpose:
    Defines classes FsStudent for document types, uploaded files, version history, expiry status, previews, and entity shortcuts.
